...
- 2016-04-12: Added ivy front-end.
- 2016-04-06: Generic functions are factored out into a backend for use with other completion frameworks like ivy.
- 2016-04-02: Added support for biblio.el which is useful for importing BibTeX entries from CrossRef and other sources.  See new fallback options and the section “Import BibTeX from CrossRef” below.
- 2016-02-25: Support for pre- and postnotes for pandoc-citeproc citations.
- 2015-11-23: Added support for keeping all notes in one org-file.  See customization variable ~bibtex-completion-notes-path~.
- 2015-11-10: Added support for PDFs specified in a BibTeX field.  See customization variable ~bibtex-completion-pdf-field~.
- 2015-11-09: Improved insertion of LaTeX cite commands.
